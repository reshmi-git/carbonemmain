              ...
              {!results ? (
                ...
                <AnimatePresence>
                  <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}>
                    {/* Winner */}
                    <div style={{ background: 'linear-gradient(135deg, var(--cream-dark), rgba(74,124,89,0.05))', border: '1.5px solid rgba(74,124,89,0.25)', borderRadius: 20, padding: 32, marginBottom: 20, position: 'relative', overflow: 'hidden' }}>
                      <span style={{ fontSize: '2.5rem', display: 'block', marginBottom: 10 }}>🥇</span>
                      <span className="badge badge-green" style={{ marginBottom: 10 }}>Best for your life</span>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 14, marginBottom: 20 }}>
                      {results.top3.slice(1).map((car, i) => (
                        <motion.div key={car.key} initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: i * 0.1 }} style={{ background: 'var(--cream-dark)', border: '1px solid var(--border)', borderRadius: 14, padding: 20, display: 'flex', alignItems: 'center', gap: 16 }}>
                          <span style={{ fontSize: '1.4rem' }}>{medals[i+1]}</span>
                          <div style={{ flex: 1 }}>
                    ...
                    <div style={{ background: 'var(--cream-mid)', border: '1px solid var(--border2)', borderRadius: 14, padding: 20, marginBottom: 20 }}>
                      <div style={{ fontFamily: 'var(--font-mono)', fontSize: 10, letterSpacing: '.1em', textTransform: 'uppercase', color: 'var(--text-muted)', marginBottom: 14 }}>⚡ Your Grid vs Other Regions</div>
                      {[
                    ...
                    <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
                      ...
                      <button className="btn btn--outline" onClick={() => navigator.clipboard.writeText(window.location.href)}>📋 Share Result</button>
                    </div>
                  </motion.div>
                </AnimatePresence>
              )}
