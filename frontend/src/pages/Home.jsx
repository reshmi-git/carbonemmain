    ...
    <div style={{ paddingTop: 72 }}>
      ...
      <section style={{
        ...
        <div style={{
          ...
          background: 'radial-gradient(ellipse 80% 60% at 70% 50%, rgba(61,74,46,0.18) 0%, transparent 65%), radial-gradient(ellipse 50% 80% at 20% 80%, rgba(196,75,43,0.06) 0%, transparent 60%), var(--carbon)',
        }} />
      ...
      <section style={{ background: 'var(--olive)', padding: '100px 0', color: 'var(--cream)' }}>
        <div className="container" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'center' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 28 }}>
            {[
              ['2.1M', 'Indians die from air pollution yearly'],
              ['14%',  'Global CO₂ from transport'],
              ['67%',  "India's electricity from coal"],
              ['₹0',   'Carbon cost shown in any car ad'],
            ].map(([num, label]) => (
              <motion.div
                key={label}
                whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 20 }}
                viewport={{ once: true }}
                style={{ background: 'rgba(245,240,232,0.06)', border: '1px solid rgba(245,240,232,0.1)', borderRadius: 14, padding: 24 }}
              >
